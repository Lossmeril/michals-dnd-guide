...
import Text, { H2, H3, H4 } from "@/components/text";
...
const ClassesPage = () => {
  return (
    <div>
      ...
      <H3>Understanding basic classes</H3>
      <Text>In this version we have 5 basic classes:</Text>
      ...
      <H3>Understanding advanced classes</H3>
      <Text>
